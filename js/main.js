...
$(function() {
    ...
    $(".myIcon").on("click", function() {
        $(".tooltips-mess").toggleClass("open-tool");
    });
    const $menu = $(".tooltips-mess");
    $(document).mouseup((e) => {
        if (!$menu.is(e.target) && $menu.has(e.target).length === 0) {
            $menu.removeClass("open-tool");
        }
    });
...
function Slide() {
    var swiper = new Swiper(".number-hot", {
        slidesPerView: 3,
        spaceBetween: 30,
        speed: 2000,
        slidesPerGroup: 1,
